...
import top.jessi.scan.action.CalendarEventAction;
import top.jessi.scan.action.ContactInfoAction;
import top.jessi.scan.action.DialAction;
import top.jessi.scan.action.EmailAction;
import top.jessi.scan.action.LocationAction;
import top.jessi.scan.action.SMSAction;
import top.jessi.scan.action.WifiAdmin;
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            if (relativeLayout != null) {
                RelativeLayout.LayoutParams lp =
                        new RelativeLayout.LayoutParams(relativeLayout.getLayoutParams().width,
        ...
        if (hmsScan.getScanType() == HmsScan.QRCODE_SCAN_TYPE) {
            ...
            if (hmsScan.getScanTypeForm() == HmsScan.PURE_TEXT_FORM) {
                ...
                copyButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    @Override
                    public void onClick(View v) {
                        startActivity(Intent.createChooser(EmailAction.getEmailInfo(hmsScan.getEmailContent()),
                    ...
                    copyButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (rawResult != null && !TextUtils.isEmpty(rawResult.getText())) {
                                ...
                                ClipData mClipData = ClipData.newPlainText("Label", rawResult.getText());
                                cm.setPrimaryClip(mClipData);
                                Toast.makeText(DisPlayActivity.this, getText(R.string.copy_toast),
